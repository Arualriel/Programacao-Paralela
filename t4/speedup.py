...
for k in range(1,7):
    ...
    for i in range(1,5):
        ...
        valuesi1 = np.loadtxt("results/results0/naoOtimizado8.txt")
        valuesi2 = np.loadtxt("results/results0/naoOtimizado9.txt")
        valuesi3 = np.loadtxt("results/results0/naoOtimizado10.txt")
        valuesi4 = np.loadtxt("results/results0/naoOtimizado11.txt")
        valuesi5 = np.loadtxt("results/results0/naoOtimizado12.txt")
        valuesi6 = np.loadtxt("results/results0/naoOtimizado13.txt")
        valuesi7 = np.loadtxt("results/results0/naoOtimizado14.txt")
        valuesi8 = np.loadtxt("results/results0/naoOtimizado15.txt")
        valuesi9 = np.loadtxt("results/results0/naoOtimizado16.txt")
        valuesi10 = np.loadtxt("results/results0/naoOtimizado17.txt")
        
        valuesi01 = np.loadtxt("results/results002/naoOtimizado8"+str(i)+".txt")
        valuesi02 = np.loadtxt("results/results002/naoOtimizado9"+str(i)+".txt")
        valuesi03 = np.loadtxt("results/results002/naoOtimizado10"+str(i)+".txt")
        valuesi04 = np.loadtxt("results/results002/naoOtimizado11"+str(i)+".txt")
        valuesi05 = np.loadtxt("results/results002/naoOtimizado12"+str(i)+".txt")
        valuesi06 = np.loadtxt("results/results002/naoOtimizado13"+str(i)+".txt")
        valuesi07 = np.loadtxt("results/results002/naoOtimizado14"+str(i)+".txt")
        valuesi08 = np.loadtxt("results/results002/naoOtimizado15"+str(i)+".txt")
        valuesi09 = np.loadtxt("results/results002/naoOtimizado16"+str(i)+".txt")
        valuesi010 = np.loadtxt("results/results002/naoOtimizado17"+str(i)+".txt")
        
        valuesi01o = np.loadtxt("results/results001/naoOtimizado8.txt")
        valuesi02o = np.loadtxt("results/results001/naoOtimizado9.txt")
        valuesi03o = np.loadtxt("results/results001/naoOtimizado10.txt")
        valuesi04o = np.loadtxt("results/results001/naoOtimizado11.txt")
        valuesi05o = np.loadtxt("results/results001/naoOtimizado12.txt")
        valuesi06o = np.loadtxt("results/results001/naoOtimizado13.txt")
        valuesi07o = np.loadtxt("results/results001/naoOtimizado14.txt")
        valuesi08o = np.loadtxt("results/results001/naoOtimizado15.txt")
        valuesi09o = np.loadtxt("results/results001/naoOtimizado16.txt")
        valuesi010o = np.loadtxt("results/results001/naoOtimizado17.txt")
    ...
    plt.legend()
    plt.savefig('speedup-cod'+str(k)+'.png', format='png')
    plt.show()
